            ...
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    ...
                    <a href="{{ route('admin.users.create') }}" class="btn btn-primary">
                        ...
                        <span class="text">{{ __('Tambah user') }}</span>
                    </a>
                    @endcan
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $user->id }}">
                                ...
                                <td>
                                    ...
                                    <form onclick="return confirm('Apakah Anda Yakin Untuk Hapus Data ? ')"  class="d-inline" action="{{ route('admin.users.destroy', $user->id) }}" method="POST">
                                        @csrf
                                        @method('delete')
